...
cleanfigure; matlab2tikz('super_script_prostate_ipoptPlan.tikz','showInfo',true,'width','\figurewidth','height','\figureheight','relativeDataPath','tikz/');
drawnow();pause(2);
close(hfPlan);
...
yticks([])
set(hCMap.Label,'String','dose [Gy]')
cleanfigure; matlab2tikz('super_script_prostate_superPlan.tikz','showInfo',true,'width','\figurewidth','height','\figureheight','relativeDataPath','tikz/');
drawnow();pause(2);
close(hfPlan);
...
yticks([])
set(hCMap.Label,'String','dose [Gy]')
cleanfigure; matlab2tikz('super_script_prostate_diffPlan.tikz','showInfo',true,'width','\figurewidth','height','\figureheight','relativeDataPath','tikz/');
drawnow();pause(2);
close(hfPlan);
...
legend(allNames{:},'Location','NorthOutside','NumColumns',4);
cleanfigure; matlab2tikz('super_script_prostate_dvhs.tikz','showInfo',true,'width','\figurewidth','height','\figureheight');
...
cleanfigure; matlab2tikz('super_script_prostate_objvsiter.tikz','showInfo',true,'width','\figurewidth','height','\figureheight');
...
ylabel('Objective function value');
legend({'Optimization','Superiorization'})
cleanfigure; matlab2tikz('super_script_prostate_objvstime.tikz','showInfo',true,'width','\figurewidth','height','\figureheight');
...
legend({'Optimization','Superiorization'});
cleanfigure; matlab2tikz('super_script_prostate_constrvsiter.tikz','showInfo',true,'width','\figurewidth','height','\figureheight');
...
ylabel('Constraint violation');
legend({'Optimization','Superiorization'})
cleanfigure; matlab2tikz('super_script_prostate_constrvstime.tikz','showInfo',true,'width','\figurewidth','height','\figureheight');
